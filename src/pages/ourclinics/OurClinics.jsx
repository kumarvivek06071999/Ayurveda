...
const OurClinics = () => {
    ...
    return (
        ...
        <div className=' bg-[#efefef]'>
            ...
            <div className=' font-roboto lg:max-w-[1140px] mx-auto px-2  pt-4 pb-8 '>
                ...
                <div className='grid grid-cols-3 gap-x-1 gap-y-2 max-sm:grid-cols-1 max-md:grid-cols-2 w-full '>
                    {
